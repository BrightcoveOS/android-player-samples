package com.brightcove.player.samples.freewheelwidevinemodular.kotlin
    ...
    private fun setupFreeWheel() {
        ...
        eventEmitter?.on(FreeWheelEventType.WILL_SUBMIT_AD_REQUEST) { event: Event ->
            ...
            val adRequestConfiguration =
                event.properties[FreeWheelController.AD_REQUEST_CONFIGURATION_KEY] as? AdRequestConfiguration
