...
import com.brightcove.player.samples.offlineplayback.java.utils.BrightcoveDownloadUtil;
...
public class MainActivity extends BrightcovePlayer {
    ...
    private void onCreate() {
        ...
        brightcoveVideoView = (BrightcoveExoPlayerVideoView) ViewUtil.findView(this, R.id.brightcove_video_view);
    ...
    private final VideoListListener videoListListener = new VideoListListener() {
        @Override
        public void playVideo(@NonNull Video video, int videoIndex) {
            MainActivity.this.playVideo(video, videoIndex);
        }
