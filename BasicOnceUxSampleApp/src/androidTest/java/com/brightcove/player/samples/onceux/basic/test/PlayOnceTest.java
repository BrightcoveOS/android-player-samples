...
/**
 * The PlayOnceTest checks the OnceUx Sample App's timeline against a predefined scenario.
 *
 * The timeline is generated by adding the events to a list, which is then checked against an array.
 *
 * The test will fail if the actual events do not match with the predifined events, or if there are
 *
 * additional events in the time alotted. 
 *
 * @author Bryan Gregory Scott
 */
